...
* **Resolução Implementada:**
  * Em [`src/e2/e2ap/constants.py`](file:///c:/Users/george.barbosa/.gemini/antigravity/scratch/iqos-xapp-rdl-phase1/src/e2/e2ap/constants.py):
```python
...
* **Resolução Implementada:**
  * Compilado o módulo canônico [`src/e2/e2ap/canonical_asn.py`](file:///c:/Users/george.barbosa/.gemini/antigravity/scratch/iqos-xapp-rdl-phase1/src/e2/e2ap/canonical_asn.py) onde `E2AP_PDU = CHOICE(name='E2AP-PDU', mode=MODE_TYPE)`.
  * Atualizado [`src/e2/e2ap/pdu.py`](file:///c:/Users/george.barbosa/.gemini/antigravity/scratch/iqos-xapp-rdl-phase1/src/e2/e2ap/pdu.py) para utilizar o `CHOICE` canônico para empacotar e desempacotar via `to_aper()` e `from_aper()`.
...
* **Resolução Implementada:**
  * Em [`src/e2/rc/capability_registry.py`](file:///c:/Users/george.barbosa/.gemini/antigravity/scratch/iqos-xapp-rdl-phase1/src/e2/rc/capability_registry.py):
```python
    if is_interop:
